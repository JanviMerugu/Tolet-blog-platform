...
const blogs = [
  ...
  },
  {
    ...
    date: 'March 26, 2024',
    image: '/blog7.png',
    content: `2024 has been a landmark year for us in terms of partnerships. From co-branded campaigns with top furniture rental companies to strategic alliances with home loan consultancies, our goal remains the same — to add value to our users. These partnerships are built on trust, mutual growth, and customer-first thinking.`,
  },
  {
    id: 8,
    ...
    date: 'March 12, 2024',
    image: '/blog8.png',
    content: `What makes a tech-driven rental platform truly human? Its people. Our team is a colorful mix of backgrounds and passions — content writers who are part-time poets, designers obsessed with pixel-perfect layouts, and backend devs who swear by dark mode.`,
  },
  {
    id: 9,
...
const BlogDetail = () => {
  ...
  return (
    <div className="blog-detail-page container py-5 text-white">
      <div className="blog-detail-header text-center mb-4">
        ...
        />
        <h2>{blog.title}</h2>
        <p className="text-info">{blog.date}</p>
      </div>
      <div className="blog-detail-content px-3 px-md-5">
        <p style={{ lineHeight: '1.8rem', fontSize: '1.1rem' }}>{blog.content}</p>
      </div>
    </div>
  );
};
